...
const schemas = {
  stats: {
    ...
    xlChance: { type: "number", default: 0 },
    superLegendaryChance: { type: "number", default: 0 },
    hatchSpeed: { type: "number", default: 0 },
    rawLuckMultiplier: { type: "number", default: 1 },
    rawSecretLuckMultiplier: { type: "number", default: 1 },
    rawCelestialLuckMultiplier: { type: "number", default: 1 },
    rawInfinityLuckMultiplier: { type: "number", default: 1 },
    rawShinyChanceMultiplier: { type: "number", default: 1 },
    rawMythicChanceMultiplier: { type: "number", default: 1 },
    rawXLChanceMultiplier: { type: "number", default: 1 },
    rawHatchSpeedMultiplier: { type: "number", default: 1 },
    ...
    xlChanceMultiplier: { type: "number", default: 1 },
    superLegendaryChanceMultiplier: { type: "number", default: 1 },
    hatchSpeedMultiplier: { type: "number", default: 0 },
    potionLuckMultiplier: { type: "number", default: 1 },
